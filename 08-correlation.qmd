...
:::
::::{.my-note-container}
With the exception of the `r glossary("qui-squared")` test of systolic blood pressure in @sec-chap05 all of the test assumptions have failed. 
