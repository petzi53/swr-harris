...
```{r}
#| label: contingency-table-voting-data
#| results: hold
...
#| fig-cap: "Opinion on voter registration and voting requirements by race / ethnicity from a study of the Pew Research Center 2017 (n = 1,028)"
...
I tried for several hours to use `after_stat()` with the same result as in @chap05-pew-voting-geom-col-graph, but I didn't succeed. I do not know if the reason is my missing knowledge (for instance to generate another structure of the data.frame) or if you can't do that in general. 
