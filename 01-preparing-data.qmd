...
Replicate data structure for Figures 1.1 and 1.2 f the book)
...
### Short description of some important packages


@lst-repl-data-fig-book used some important package that I haven't profiled until now:

I used {**dplyr**} in the above code heavily. {**dplyr**} is part of the {**tidyverse**} core collection, together with {**forcats**}, {**ggplot2**}, {**readr**}, {**tibble**}, {**tidyr**}, {**string**} and {**purrr**}. The last two packages ({**string**} and {**purrr**}) I will profile when I use them the first time and {**forcats**} that I have mentioned in the comment to @lst-repl-data-fig-book I have outlined elsewhere (see: @pak-forcats). 
...
chap01_nhanes_2013_grouped <- 
    readRDS("data-clean/chap01_nhanes_2013_grouped.rds")
...
gss_2016_man <- 
    readRDS("data-raw/gss_2016_man.rds")
...
chap01_gtsummary_basic <- 
    readRDS("data-clean/chap01_gtsummary_clean.rds")
