...
`my_glance_data()` my private command. (See
...
The idea of `my_glance_data()` is to get a first impression of the dataset.
...
Maybe you are interested to use `my_glance_data()` yourself? It isn't
