...
#| lst-label: lst-check-skew-normal
#| lst-cap: "Checking skewness of a shoulder breadth distribution of 247 men"
#| cache: true
#| results: hold
...
## construct graph using my private function hist_dnorm()
p <- hist_dnorm(age80, age80$`_AGE80`, n_bins = 62)
...
## construct graph using my private function hist_dnorm()
p <- hist_dnorm(age79, age79$`_AGE79`, n_bins = 61)
