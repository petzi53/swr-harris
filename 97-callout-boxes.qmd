...
So far I haven't used the "Tip" callout box with numbering. As I have provided many theorems with different names I haven’t needed the tip box so far. Most of the tips are collected under the theorem variation "Lemma" with the label "Resource". Sometimes I have written essential reminders for my learning activities into the "Important" box.

If I will apply this callout box as a "Tip" in the future then I have to clarify its usage in contrast to other boxes.
...
So far I haven't used this callout box, but an unnumbered custom box alternative 22x. Again I am planning an transfer to a numbered alternative, possibly to this callout box.
:::
