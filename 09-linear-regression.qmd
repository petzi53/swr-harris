...
ggplot2::ggplot(
  ...
  ggplot2::labs(
      x = "Nearest syringe services program in miles (standardized)",
...
x1 <- distance_ssp_clean |> 
    tidyr::drop_na(hiv_prevalence)
