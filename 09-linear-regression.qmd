...
::::{.my-r-code-container}
```{r}
#| label: tbl-regression-with-residuals
#| tbl-cap: "Relationship between percentage without health insurance and distance to nearest syringe program in 500 counties with residuals"
...
The output of @lst-est-lm-r for the linear model included a `r glossary("p-value")` for the `r glossary("slope")` (<2e16) and a p-value for the `r glossary("intercept")` (0.221). 
...
```{r}
#| label: tbl-confint
#| tbl-cap: "Computing confidence interval for regression parameters"
...
#| lst-label: lst-chap09-predict-one-value
#| lst-cap: "Predict distance for a county where 10% of people are uninsured"
...
```{r}
#| label: tbl-predict-all-values
#| tbl-cap: "Predicted values for all observed x"
