...
- **Achievement 3**: Comparing two unrelated sample means with an `r glossary("independent-samples t-test")` {#sec-chap06-achievement3}
- **Achievement 4**: Comparing two related sample means with a `r glossary("dependent-samples t-test")` {#sec-chap06-achievement4}
