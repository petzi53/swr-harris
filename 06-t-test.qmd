...
- [Effect size calculator](https://www.ai-therapy.com/psychology-statistics/effect-size-calculator) (AI-Thearpie Statistics)
...
```{r}
#| label: donwload-numbers-cohens-d-packages
#| include: false
#| eval: false
...
```{r}
#| label: pkgs-anderson-darling-test
#| include: false
#| eval: false

pkgs_dl(c("cmstatr", "DescTools", "kSamples", "nortest"))
```
...
```{r}
#| label: pkgs-downloads-levene-test
#| include: false
#| eval: false

pkgs_dl(c("car", "DescTools", "misty", "rstatix"))
```
...
```{r}
#| label: pkgs-downloads-sign-test
#| include: false
#| eval: false

pkgs_dl(c("BSDA", "DescTools", "rstatix"))
```
...
```{r}
#| label: pkgs-dl-alternative-tests
#| include: false
#| eval: false
