...
and solves more of the problems that `r glossary("APIx", "API")` wrapping
...
I have already listed some reasons why the above result is still not the real amount of circulated guns per year in the US (see: @rem-chap03-circulated-guns-us)
...
should appear for this binary variable.
:::
:::
...
::: {.my-resource}
::: {.my-resource-header}
:::::: {#lem-chap03-kernel-density-bandwidth}
...
###### Practice test {#sec-chap03-practice-test}

:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-chap03-color-test-bw}
: Test how my used colors look for printing in black & white
::::::
:::
::::{.my-r-code-container}


::: {#lst-chap03-color-test-bw}

```{r}
#| label: fig-color-test-bw
#| fig-cap: "Test if used colors of my graph gun-use by sex are also readable in black & white printing"
#| fig-height: 3
#| results: hold
...
- If you do not use all colors you can exactly provide all parameters of your scale & color choice to `colorspace::desaturate()`. For instance: `colorspace::desaturate(viridis::turbo(5, 0.5, .25, .75, -1))` See for a practice test @lst-chap03-color-test-bw.

:::::{.my-resource}
:::{.my-resource-header}
:::::: {#lem-chap03-colorblind-friendly-palettes}
...
#| fig-cap: "This is the graph with the default {**ggplot2**} palette."
...
**Update**: Yes, In the meanwhile I have confirmed my assumption! @cnj-chap05-pew-voting-geom-col-graph shows an example where the `alpha` argument is working! 
...
::: {.my-resource}
::: {.my-resource-header}
:::::: {#lem-chap03-ggplot2-code-examples}
...
-   **Plotting anything with {**ggplot2**}: [Video
    ...
    {**ggplot2**} and how it is reflected in the `r glossary("APIx", "API")`.
